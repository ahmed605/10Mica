...
inline winrt::Windows::Graphics::Effects::IGraphicsEffectSource& to_winrt(abi::IGraphicsEffectSource*& instance)
{
    return reinterpret_cast<winrt::Windows::Graphics::Effects::IGraphicsEffectSource&>(instance);
}

inline winrt::Windows::Foundation::IPropertyValue& to_winrt(abi::IPropertyValue*& instance)
{
    return reinterpret_cast<winrt::Windows::Foundation::IPropertyValue&>(instance);
}
...
namespace winrt::Microsoft { namespace UI { namespace Private { namespace Composition { namespace Effects::implementation
{
    ...
    namespace UI {
        namespace Private {
            namespace Composition {
                namespace Effects::factory_implementation
                {
                    class GaussianBlurEffect : public GaussianBlurEffectT<GaussianBlurEffect, implementation::GaussianBlurEffect>
                    {
                    };

                    class ColorSourceEffect : public ColorSourceEffectT<ColorSourceEffect, implementation::ColorSourceEffect>
                    {
                    };

                    class OpacityEffect : public OpacityEffectT<OpacityEffect, implementation::OpacityEffect>
                    {
                    };

                    class BlendEffect : public BlendEffectT<BlendEffect, implementation::BlendEffect>
                    {
                    };

                    class CrossFadeEffect : public CrossFadeEffectT<CrossFadeEffect, implementation::CrossFadeEffect>
                    {
                    };
                }
            }
